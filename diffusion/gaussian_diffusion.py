...
class GaussianDiffusion:
    ...
    def p_sample_loop(
        ...
        for i, sample in enumerate(self.p_sample_loop_progressive(
            ...
            final = sample
            if vae:
                samples, _ = final["sample"].chunk(2, dim=0)  # Remove null class samples
                samples = vae.decode(samples / 0.18215).sample
                save_image(samples, "step_pred/sample_{}.png".format(i), nrow=4, normalize=True, value_range=(-1, 1))
        return final["sample"]
